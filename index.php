        ...
        <div class="owl-carousel header-carousel py-5">
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="carousel-text">
                            <h1 class="display-1 text-uppercase mb-3">KALU! Together for a Better Tomorrow</h1>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="carousel-text">
                            <h1 class="display-1 text-uppercase mb-3">UCHENDU! Together, We Can End Hunger and Starvation.</h1>
            ...
            <div class="row g-0">
                <div class="col-lg-11">
                    <div class="h-100 py-5 d-flex align-items-center">
                        ...
                        <h3 class="ms-5 mb-0">Mr. Kalu! Together, we can build a world where everyone has the chance to thrive.
                        </h3>
                    </div>
                </div>
